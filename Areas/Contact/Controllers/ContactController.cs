...
namespace MVC.Areas.Contact.Controllers
{
    ...
    public class ContactController : Controller
    {
        ...
        [HttpGet("/contact/details/{id:int?}")]
        ...
        public async Task<IActionResult> SendContact([Bind("FullName,Email,Message,PhoneNumber")] MVC.Models.Contact.Contact contact)
        {
            if (ModelState.IsValid)
            {
                ...
                StatusMessage = "Added contact successfully";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,SentDate,Message,PhoneNumber")] MVC.Models.Contact.Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
